...
public class Util {
	...
	public static final String recoveryStoreDir = dataDir
			+ "/recoveryTestStore";
	public static final String hornetqStoreDir = dataDir + "/hornetq";

	public static void emptyObjectStore() {
		String objectStoreDirName = BeanPopulator.getDefaultInstance(
				ObjectStoreEnvironmentBean.class).getObjectStoreDir();
